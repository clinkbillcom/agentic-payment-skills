...
function catalogCandidateIdentityResolution(candidate = {}, pending = {}, frozenContext = null) {
  ...
  const internalMerchantUrl = fields.merchantUrl.value ?? fields.productUrl.value;
  ...
  return {
    ...
    identity: {
      ...
      ...(internalCatalog && internalMerchantUrl
        ? { merchantUrl: internalMerchantUrl }
        : fields.merchantUrl.value
          ? { merchantUrl: fields.merchantUrl.value }
          : {}),
