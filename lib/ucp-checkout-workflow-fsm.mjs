...
const PAYMENT_SUCCESS_POLL_COMMAND = 'clink events poll --type agent_order.succeeded --max-wait 900 --format json';
  ...
  if (successEvent) {
    ...
    if (omsOrderId) {
      return {
        ...
        omsOrderId,
        orderPermalinkUrl,
        orderCommand: `clink ucp-order get --order-id ${shellQuoteIfNeeded(omsOrderId)} --format json`,
      };
    }
    return {
