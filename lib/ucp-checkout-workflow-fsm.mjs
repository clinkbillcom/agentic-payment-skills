...
function classifyNormalizedAliases(values = []) {
...
function checkoutIdAliasesOf(data = {}, { includeId = true } = {}) {
  return classifyNormalizedAliases([
    data.checkoutId,
    data.checkout_id,
    ...(includeId ? [data.id] : []),
  ]);
...
function validateCorrelatedPaymentSuccessContext(context = {}) {
  ...
  const suppliedPaymentOrderAliases = classifyNormalizedAliases([
...
export function classifyUcpCheckoutObservation(observation = {}) {
  ...
  return checkoutEndpoint ? { ...result, checkoutEndpoint } : result;
}
