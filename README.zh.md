...
- Visa 全量、品类和品牌权益查询，首轮只执行一次纯 Visa
  `visa recommend`，不调用 UCP 或 Catalog
...
Skill `0.1.40` 已 vendor 上游提交
`86de0ff71bca0a24acd07ea9bd9236f45f684d7e` 的 Visa CLI `0.2.41`。它支持
