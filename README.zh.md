...
- 同一份原始 query 同时用于 Visa keyword、命中商户后的 Catalog 搜索和第一条
  broad Catalog 搜索；Offer 标题只作为展示信息
...
Skill `0.1.60` 已 vendor 上游提交
`c25a4e44ba33705892027ffcf9a7bd53ef4723ed` 的 Visa CLI `0.2.53`。它支持
