...
- Strong-auth agentic authorization preparation (Visa/Mastercard capability check, Instruction reuse/create, CLI-owned no-card PENDING continuation, and page-driven completion)
